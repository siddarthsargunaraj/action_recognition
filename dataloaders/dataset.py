...
class VideoDataset(Dataset):
    ...
    def __init__(self, split='train', clip_len=16, preprocess=False):
        self.root_dir, self.output_dir = Path.db_dir()
...
if __name__ == "__main__":
    ...
    train_data = VideoDataset(split='train', clip_len=16, preprocess=False)
