...
def train_model(save_dir=save_dir, num_classes=num_classes, lr=lr,
    ...
    train_dataloader = DataLoader(VideoDataset(split='train',clip_len=16), batch_size=1, shuffle=True, num_workers=0)
    val_dataloader   = DataLoader(VideoDataset(split='val',  clip_len=16), batch_size=1, num_workers=0)
    test_dataloader  = DataLoader(VideoDataset(split='test', clip_len=16), batch_size=1, num_workers=0)
